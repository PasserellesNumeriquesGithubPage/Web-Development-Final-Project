  ...
  <h5 class="card-title">Online Auction || Seller Registration Process</h5>
    ...
    <div>
        ...
        if(isset($_POST['register'])){
            ...
            $sql = "INSERT INTO tbl_sellers (username,password,first_name,last_name,contact_no,profile_img) VALUES('$set_username','$set_password','$first_name','$last_name','$contact_no','$img');";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <label for="profileimg"><b>Upload Image</b></label>
